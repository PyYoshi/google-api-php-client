...
class Client
{
    ...
    /**
     * @var \Google\IO\IoAbstract $io
     */
    private $io;

    /**
     * @var \Google\Cache\CacheAbstract $cache
     */
    private $cache;
    ...
    /**
     * @var \Google\Logger\LoggerAbstract $logger
     */
    private $logger;
    ...
    public function loadServiceAccountJson($jsonLocation, $scopes)
    {
        ...
        if (isset($data->type) && $data->type == 'service_account') {
            ...
            $cred = new \Google\Auth\AssertionCredentials(
                $data->client_email,
                $scopes,
                $data->private_key
            );
            ...
            throw new \Google\Exception("Invalid service account JSON file.");
        }
    }
    ...
    public function setAuthConfig($json)
    {
        ...
        if (!isset($data->$key)) {
            throw new \Google\Exception("Invalid client secret JSON file.");
        }
    ...
    public function prepareScopes()
    {
        if (empty($this->requestedScopes)) {
            throw new \Google\Auth\Exception("No scopes specified");
        }
     ...
     * @param \Google\Auth\AuthAbstract $auth
     */
    public function setAuth(\Google\Auth\AuthAbstract $auth)
    {
    ...
    /**
     * Set the IO object
     * @param \Google\IO\IoAbstract $auth
     */
    public function setIo(\Google\IO\IoAbstract $io)
    {
    ...
    {
        $auth = new \Google\Auth\OAuth2($this);
    ...
    {
        if ($request instanceof \Google\Http\Request) {
    ...
    /**
     * @return \Google\Auth\AuthAbstract Authentication implementation
     */
    ...
    /**
     * @return \Google\IO\IoAbstract IO implementation
     */
    ...
    /**
     * @return \Google\Cache\CacheAbstract Cache implementation
     */
