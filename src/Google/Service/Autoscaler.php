 ...
 * @author Google, Inc.
 */
class Autoscaler extends \Google\Service
{
    ...
    public function __construct(\Google\Client $client)
    {
        ...
        $this->autoscalers = new \Google\Service\Autoscaler\Autoscalers\Resource(
            $this,
            $this->serviceName,
            'autoscalers',
            array(
        ...
        $this->zoneOperations = new \Google\Service\Autoscaler\ZoneOperations\Resource(
            $this,
            $this->serviceName,
            'zoneOperations',
            array(
        ...
        $this->zones = new \Google\Service\Autoscaler\Zones\Resource(
            $this,
            $this->serviceName,
            'zones',
            array(
