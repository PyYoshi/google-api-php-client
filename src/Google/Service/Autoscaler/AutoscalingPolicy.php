...
namespace Google\Service\Autoscaler;
...
class AutoscalingPolicy extends \Google\Collection
{
    ...
    protected $cpuUtilizationType = 'Google\Service\Autoscaler\AutoscalingPolicyCpuUtilization';
    protected $cpuUtilizationDataType = '';
    protected $customMetricUtilizationsType = 'Google\Service\Autoscaler\AutoscalingPolicyCustomMetricUtilization';
    protected $customMetricUtilizationsDataType = 'array';
    protected $loadBalancingUtilizationType = 'Google\Service\Autoscaler\AutoscalingPolicyLoadBalancingUtilization';
    ...
    public function setCpuUtilization(\Google\Service\Autoscaler\AutoscalingPolicyCpuUtilization $cpuUtilization)
    {
    ...
    public function setLoadBalancingUtilization(
        \Google\Service\Autoscaler\AutoscalingPolicyLoadBalancingUtilization $loadBalancingUtilization
    ) {
