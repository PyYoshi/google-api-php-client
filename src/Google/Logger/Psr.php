 ...
 * with the `\Google\Logger\Psr::setLogger()` method.
 */
class Psr extends \Google\Logger\LoggerAbstract
{
    /**
     ...
     */
    public function __construct(\Google\Client $client, /*Psr\Log\LoggerInterface*/ $logger = null)
    {
