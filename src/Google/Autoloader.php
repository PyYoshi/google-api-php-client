<?php
/**
 * Based from https://github.com/fluent/fluent-logger-php/blob/master/src/Fluent/Autoloader.php
 *
 * Copyright 2014 Yoshihiro Misawa <myoshi321go@gmail.com>.
 *
...
class Autoloader
{
    const NAME_SPACE = 'Google';
    protected static $base_dir;

    /**
     * register Google basic autoloader
     *
