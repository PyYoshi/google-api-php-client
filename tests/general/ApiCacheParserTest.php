...
class ApiCacheParserTest extends BaseTest
{
  public function testIsResponseCacheable()
  {
    ...
    $resp = new \Google\Http\Request('http://localhost', 'POST');
    $result = \Google\Http\CacheParser::isResponseCacheable($resp);
    $this->assertFalse($result);

    // The response has expired, and we don't have an etag for
    // revalidation.
    $resp = new \Google\Http\Request('http://localhost', 'GET');
    ...
    $resp = new \Google\Http\Request('http://localhost', 'HEAD');
    $resp->setResponseHttpCode('200');
  ...
  public function testIsExpired()
  {
    ...
    $this->assertFalse(\Google\Http\CacheParser::isExpired($resp));
    ...
    $this->assertTrue(\Google\Http\CacheParser::isExpired($resp));
  ...
  public function testMustRevalidate()
  {
    ...
    $this->assertFalse(\Google\Http\CacheParser::mustRevalidate($resp));
    ...
    $this->assertTrue(\Google\Http\CacheParser::mustRevalidate($resp));
