...
//    $date->setDate(\Google\Model::NULL_VALUE);
//    $event->setStart($date);
//    $obj = json_decode(json_encode($event->toSimpleObject()), true);
...
//
//    $event2 = new \Google\Service\Calendar\Event();
//    $this->assertNull($event2->getStart());
    }

    public function testVariantTypes()
    {
//    $feature = new \Google\Service\MapsEngine\Feature();
//    $geometry = new \Google\Service\MapsEngine\GeoJsonPoint();
...
//    $this->assertEquals(1, $data['geometry']['coordinates'][0]);
    ...
    {
//    $creative = new \Google\Service\AdExchangeBuyer\Creative();
...
//        true
//    );
//    $collection = new \Google\Service\Calendar\Events($data);
